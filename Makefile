...
pkgdatadir = $(datadir)/csdbg
pkgincludedir = $(includedir)/csdbg
pkglibdir = $(libdir)/csdbg
pkglibexecdir = $(libexecdir)/csdbg
...
ACLOCAL = ${SHELL} /home/antonis/libcsdbg/csdbg-automake/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/antonis/libcsdbg/csdbg-automake/missing autoconf
AUTOHEADER = ${SHELL} /home/antonis/libcsdbg/csdbg-automake/missing autoheader
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/antonis/libcsdbg/csdbg-automake/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_NAME = csdbg
PACKAGE_STRING = csdbg 1.29
PACKAGE_TARNAME = csdbg
PACKAGE_URL = 
...
STRIP = strip
VERSION = 1.29
abs_builddir = /home/antonis/libcsdbg/csdbg-automake
abs_srcdir = /home/antonis/libcsdbg/csdbg-automake
abs_top_builddir = /home/antonis/libcsdbg/csdbg-automake
abs_top_srcdir = /home/antonis/libcsdbg/csdbg-automake
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/antonis/libcsdbg/csdbg-automake/install-sh
...
# -W options
WOPTS = all abi ctor-dtor-privacy non-virtual-dtor format-security \
	init-self missing-include-dirs switch-enum cast-align \
	cast-qual clobbered empty-body sign-compare logical-op \
	missing-field-initializers packed redundant-decls \
	overlength-strings disabled-optimization missing-noreturn \
	type-limits
